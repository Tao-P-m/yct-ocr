...
print(ocrModel)
#ocrModel = '/home/lx/Downloads/ID_programmer/models/modellstm.pth'
#chinsesModel = True
def crnnSource():
    """
    加载模型
...
#ocrModel = '/home/lx/Downloads/ID_programmer/models/modellstm_n.pth'
#chinsesModel = False
#def crnnSource_number():
#    """
#    加载模型
#    """
#    if chinsesModel:
...
#
#
#model_n,converter_n = crnnSource_number()
#print(converter_n)
#model_n.eval()
#def crnnOcr_number(image):
#       """
#       crnn模型，ocr识别
#       image:PIL.Image.convert("L")
#       """
...
#       _, preds    = preds.max(2)
#       preds       = preds.transpose(1, 0).contiguous().view(-1)
#       sim_pred    = converter_n.decode(preds)
#       return sim_pred
